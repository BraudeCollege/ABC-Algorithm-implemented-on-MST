...
/**
 * ****************************************************************************
 * Compilation: javac IndexFibonacciMinPQ.java Execution:
 *
...
public class IndexFibonacciMinPQ<Key> implements Iterable<Integer> {
     ...
     *
     * @param N number of keys in the priority queue, index from {@code 0} to
     * {@code N-1}
     ...
     *
     * @param i an index
     * @throws java.lang.IndexOutOfBoundsException if the specified index is
     * invalid
     ...
     * @throws java.lang.IndexOutOfBoundsException if the specified index is
     * invalid
     * @throws java.lang.IllegalArgumentException if the index is already in the
     * queue
     */
     ...
     * @throws java.lang.IndexOutOfBoundsException if the specified index is
     * invalid
     * @throws java.util.NoSuchElementException if the index has no key
     * associated with
     */
     ...
     * @throws java.util.NoSuchElementException if the index has no key
     * associated with
     * @throws java.lang.IllegalArgumentException if the given key is greater
     ...
     * @throws java.util.NoSuchElementException if the index has no key
     * associated with
     * @throws java.lang.IllegalArgumentException if the given key is lower than
     * the current key
     */
     ...
     * @throws java.lang.IndexOutOfBoundsException if the specified index is
     * invalid
     * @throws java.util.NoSuchElementException if the given index has no key
     * associated with
     */
    ...
    private void consolidate() {
        ...
        head = null;
        table.values().stream().map((nq) -> {
            min = greater(min.key, nq.key) ? nq : min;
            return nq;
        }).forEach((nk) -> {
            head = insert(nk, head);
        });
